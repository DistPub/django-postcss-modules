...
version = get_version('postcss_modules')

setup(
    name='django-postcss-modules',
    version=version,
    url='https://github.com/DistPub/django-postcss-modules',
    license='MIT',
    description='Bring `postcss-modules` to your django project, transpiling static .cssm files on the fly, without NodeJS require!',
